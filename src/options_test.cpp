...
int main()
{
  ...
  }
  {
    ...
    if(ret != 0)
    {
      ...
      std::cerr << "Empty gui short option test returned error" << std::endl;
      return 1;
    }
    ...
    if(options.gui != true)
    {
      ...
      std::cerr << "There was an error processing the empty gui short option"
                << std::endl;
      return 1;
    }
  }
